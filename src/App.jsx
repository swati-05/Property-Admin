...
const ModuleOption = React.lazy(() => import('@/Pages/Mobile/ModuleOption'))
const PropertyOptions = React.lazy(() => import('@/Pages/Mobile/PropertyOptions'))
const MobileHeader = React.lazy(() => import('@/Pages/Mobile/MobileHeader'))
const VerificationOptions = React.lazy(() => import('@/Pages/Mobile/VerificationOptions'))
