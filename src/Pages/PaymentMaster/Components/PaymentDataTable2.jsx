...
//    Revision - 1
//    Project - JUIDCO
//    Component  - PaymentDataTable2
//    DESCRIPTION -PaymentDataTable2
//////////////////////////////////////////////////////////////////////////////////////
...
function PaymentDataTable2({ searchText, fun, columns, data, ...rest }) {
    ...
    <>
      <div className="overflow-hidden mx-2">
        <div className='flex'>
          ...
          <div className='flex-initial'><SearchComponent2 searchText={searchText} filter={globalFilter} setFilter={setGlobalFilter} /></div>
          <div className='ml-2'><button className='bg-sky-400 px-3 my-2 pr-3 shadow-lg rounded py-1.5 text-white hover:shadow-2xl hover:bg-green-600 text-center relative' onMouseEnter={() => setbounce('')} onMouseLeave={() => setbounce('hidden')}><CSVLink data={data}> Export Data</CSVLink><div className={bounce + ' absolute h-full top-3 text-sm left-0 text-center animate-bounce'}><AiOutlineArrowDown /></div></button></div>
        </div>

        <table {...getTableProps()} className="min-w-full leading-normal">
          <thead className='font-bold text-center text-sm bg-gray-200'>
                ...
                <tr className='' {...row.getRowProps()} >
                  {row.cells.map(cell => {
                    return <td
                      ...
                      className="px-2 py-2 bg-white text-left leading-4 text-sm text-gray-900 tracking-wider border-b"
...
export default PaymentDataTable2
