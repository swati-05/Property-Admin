...
//    Revision - 1
//    Project - JUIDCO
//    Component  - CitizenDocumentView (closed)
//    DESCRIPTION - CitizenDocumentView Component
import { useState } from 'react'
import PropertySafDocumentRow from "./CitizenDocumentRow"
import Modal from 'react-modal';
import dummy from './dummy.pdf'
import CitizenDocumentRow from './CitizenDocumentRow';
                            ...
                            <table className="min-w-full leading-normal">
                                ...
                                <tbody>
                                {
                                        docList.map((data, index) => (
                                            <CitizenDocumentRow openModal={modalAction} docList={data} index={index} />
                                        ))
                                    }
...
export default CitizenDocumentView
/**
 * Exported to :
