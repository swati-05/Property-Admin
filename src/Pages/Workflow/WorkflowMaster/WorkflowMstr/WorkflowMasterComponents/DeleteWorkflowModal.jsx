...
function DeleteRoleModal(props) {
  ...
  const handleDelete = (id) => {
    ...
    axios
      ...
      .then(
        (res) => (toast.success("Workflow Deleted successfully"), closeModal(), setrefresh(refresh+1))
      )
      .catch(
        (err) => (toast.error("Failed to Deleted the Workflow"), closeModal())
      );
  };
