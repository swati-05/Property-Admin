            ...
            <div className="flex items-center justify-center text-black" id="printableArea">
                <div className="container w-[70%] border-2 border-dashed m-2 overflow-x-hidden border-black py-4 px-3 relative">
                    ...
                    <div className="text-start text-xs">
                        Mr/Mrs/Ms: <span className="font-semibold capitalize">{nullToNA(samDetails?.owner_name)} {nullToNA(samDetails?.relation_type)} {nullToNA(samDetails?.guardian_name)}</span> <br />
                        Address: <span className="font-semibold capitalize">{nullToNA(samDetails?.prop_address)}</span>
                    </div>
