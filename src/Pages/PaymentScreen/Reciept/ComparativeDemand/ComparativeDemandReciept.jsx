        ...
        <div>
              <div className="flex flex-col justify-center items-center gap-x-4">
                  ...
                  <div className="text-xs font-semibold flex flex-col justify-center items-center">
                    ...
                    <span>E-mail ID - {dataList?.basicDetails?.email}</span>
                  </div>
          ...
          <div className='flex flex-col'>
            <span className='font-semibold'>Letter: <span>{dataList?.basicDetails?.letter}</span> </span>
            <span className='font-semibold'>Date: <span>{dataList?.basicDetails?.letter}</span> </span>
          </div>
          ...
          <table className="w-full mt-2">
            ...
            {arvData?.length > 0 && 
              ...
              <tr>
                ...
                <td className="border-[1px] border-gray-700 pl-1">{data?.floor}</td>
                <td className="border-[1px] border-gray-700 pl-1">{data?.buildupArea}</td>
                <td className="border-[1px] border-gray-700 pl-1">{data?.usageFactor}</td>
                <td className="border-[1px] border-gray-700 pl-1">{data?.occupancyFactor}</td>
                <td className="border-[1px] border-gray-700 pl-1">{data?.carpetArea}</td>
                <td className="border-[1px] border-gray-700 pl-1">{data?.rentalRate}</td>
                <td className="border-[1px] border-gray-700 pl-1">{data?.taxPerc}</td>
                <td className="border-[1px] border-gray-700 pl-1">{data?.calculationFactor}</td>
                <td className="border-[1px] border-gray-700 pl-1">{data?.arvPsf}</td>
                <td className="border-[1px] border-gray-700 pl-1">{data?.circleRate}</td>
                <td className="border-[1px] border-gray-700 pl-1">{data?.arvTotalPropTax}</td>
                <td className="border-[1px] border-gray-700 pl-1">{data?.cvArvPropTax}</td>
            </tr>
              )
            }
            ...
            <tr>
              ...
              <td className="border-[1px] border-gray-700 pl-1">{dataList?.total?.arvTotalPropTax}</td>
              <td className="border-[1px] border-gray-700 pl-1">{dataList?.total?.cvTotalPropTax}</td>
            </tr>
