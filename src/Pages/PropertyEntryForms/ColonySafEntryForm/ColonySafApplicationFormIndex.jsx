...
import GovSafOwner from './GovSafOwner'
import GovSafFloor from './GovSafFloor'
import GovSafExtra from './GovSafExtra'
import { TbWebhook } from 'react-icons/tb'
import ColonySafBasicDetails from './ColonySafBasicDetails'


function ColonySafApplicationFormIndex() {
    ...
    return (
        <>
            ...
            <div className='text-right relative top-0'>
                <span className='bg-sky-100 border-l border-b border-white text-black col-span-12 sm:col-span-2 sm:col-start-11 pl-4 rounded-l shadow-lg font-semibold pr-4'><TbWebhook className='inline' /> Colony SAF Entry</span></div>
            ...
            <div className={`${animateform1} transition-all relative`}><ColonySafBasicDetails collectFormDataFun={collectAllFormData} submitFun={submitButtonToggle} toastFun={notify} backFun={backFun} nextFun={nextFun} /></div>
...
export default ColonySafApplicationFormIndex