                    ...
                    <table className='min-w-full leading-normal'>
                        <thead className='font-bold text-left text-sm bg-sky-50'>
                            <tr>
                                ...
                                <th className="px-2 py-3 border-b border-gray-200 text-gray-800  text-xs capitalize text-left">Mobile</th>
                                <th className="px-2 py-3 border-b border-gray-200 text-gray-800  text-xs capitalize text-left">Aadhar</th>
                                <th className="px-2 py-3 border-b border-gray-200 text-gray-800  text-xs capitalize text-left">PAN</th>
                                <th className="px-2 py-3 border-b border-gray-200 text-gray-800  text-xs capitalize text-left">EmailId</th>
                                <th className="px-2 py-3 border-b border-gray-200 text-gray-800  text-xs capitalize text-left">IsArmed</th>
                                <th className="px-2 py-3 border-b border-gray-200 text-gray-800  text-xs capitalize text-left">IsSpecially</th>
