...
import { allowCharacterCommaInput, allowCharacterNumberSpaceCommaInput, allowCharacterNumberSpaceInput, allowCharacterSpaceCommaInput } from '@/Components/Common/PowerUps/PowerupFunctions'
...
function GovSafOwner(props) {
    ...
    const handleChange = (e)=>{
        ...
        {name=='designation' &&  formik.setFieldValue("designation",allowCharacterSpaceCommaInput(value,formik.values.designation,100))} //(currentValue,oldValue,max,isCapital)
        {name=='address' &&  formik.setFieldValue("address",allowCharacterNumberSpaceCommaInput(value,formik.values.address,200))} 
    }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4">
                        ...
                        <div className="col-span-4 grid grid-cols-1 md:grid-cols-4">
                            ...
                            <div className="form-group col-span-4 md:col-span-1 mb-6 md:px-4">
                                <label className="form-label inline-block mb-1 text-gray-600 text-sm font-semibold"><small className="block mt-1 text-sm font-semibold text-red-600 inline ">*</small>Designation</label>
                            ...
                            <div className="form-group mb-6 col-span-4 md:col-span-3 md:px-4">
                                <label className="form-label inline-block mb-1 text-gray-600 text-sm font-semibold"><small className="block mt-1 text-sm font-semibold text-red-600 inline ">*</small>Address </label>
