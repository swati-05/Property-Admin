...
function WaterHarvestingScreen(props) {
    ...
    console.log("props master data in water harvesting preformdata", props.preFormData)

    return (
        <>
            <h1 className='mt-6 mb-2 font-serif font-semibold absolute text-gray-600'><RiBuilding2Fill className="inline mr-2" />Rain Water Harvesting</h1>
            ...
            <div className="block p-4 w-full md:py-6 rounded-lg shadow-lg bg-white mx-auto absolute top-14">
                ...
                <form onSubmit={formik.handleSubmit} onChange={formik.handleChange}>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 p-2 gap-4'>
                        ...
                        <div className='col-span-1'>
                            <div className='flex flex-row space-x-3'>
                                <label className="form-label inline-block mb-1 text-gray-600 text-sm font-semibold"><small className="block mt-1 text-sm font-semibold text-red-600 inline ">*</small>Does Completion of Water Harvesting is done before 31-03-2017?  </label>
                                <input
                                    ...
                                    required
                                />
                                <label for="option1" className=" text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                                ...
                                <input
                                    ...
                                    required
                                />
                                <label for="option1" className="text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 p-2 gap-4'>
                        ...
                        <div className='col-span-1'>
                            <label className="form-label inline-block mb-1 text-gray-600 text-sm font-semibold"><small className="block mt-1 text-sm font-semibold text-red-600 inline ">*</small>Name </label>
                            <input type="text" name='name' className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none placeholder-gray-300 shadow-md"
                                placeholder=""
                                value={formik.values.name} onChange={formik.handleChange}
                            />
                            <p className='text-red-500 text-xs'>{formik.touched.name && formik.errors.name ? formik.errors.name : null}</p>

                        </div>
                        <div className='col-span-1'>
                            <label className="form-label inline-block mb-1 text-gray-600 text-sm font-semibold"><small className="block mt-1 text-sm font-semibold text-red-600 inline ">*</small>Guardian Name </label>
                            <input type="text" name='guardianName' className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none placeholder-gray-300 shadow-md"
                                placeholder=""
                                value={formik.values.guardianName} onChange={formik.handleChange}
                            />
                        ...
                        <div className='col-span-1'>
                            ...
                            <select type="text" name='wardNo' className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none placeholder-gray-300 shadow-md"
                                placeholder=""
                                value={formik.values.wardNo} onChange={formik.handleChange}
                            >
                                <option value=''>select</option>
                                {props?.preFormData?.map((items) => (
                                    <option value={items.id}>{items?.ward}</option>
                                ))}
                            </select>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 p-2 gap-4'>
                        ...
                        <div className='col-span-1'>
                            ...
                            <input type="number" name='mobileNo' className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none placeholder-gray-300 shadow-md" max={9999999999}
                                placeholder=""
                        ...
                        <div className='col-span-1'>
                            <label className="form-label inline-block mb-1 text-gray-600 text-sm font-semibold"><small className="block mt-1 text-sm font-semibold text-red-600 inline ">*</small>15 Digits Holding No./ SAF No.</label>
                            <input type="number" name='holdingNo' className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none placeholder-gray-300 shadow-md"
                                placeholder=""
                                value={formik.values.holdingNo} onChange={formik.handleChange}
                            />
                            <p className='text-red-500 text-xs'>{formik.touched.holdingNo && formik.errors.holdingNo ? formik.errors.holdingNo : null}</p>

                        </div>
                        <div className='col-span-1'>
                            <label className="form-label inline-block mb-1 text-gray-600 text-sm font-semibold"><small className="block mt-1 text-sm font-semibold text-red-600 inline ">*</small>Name of Building and Address </label>
                            <input type="text" name='buildingAddress' className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none placeholder-gray-300 shadow-md"
                                placeholder=""
                                value={formik.values.buildingAddress} onChange={formik.handleChange}
                            />
                            <p className='text-red-500 text-xs'>{formik.touched.buildingAddress && formik.errors.buildingAddress ? formik.errors.buildingAddress : null}</p>

                        </div>
                        <div className='col-span-1'>
                            <label className="form-label inline-block mb-1 text-gray-600 text-sm font-semibold">
                                <small className="block mt-1 text-sm font-semibold text-red-600 inline ">*</small>
                            Date of Completion of Water Harvesting Structure</label>
                            ...
                            />
                            <p className='text-red-500 text-xs'>{formik.touched.dateOfCompletion && formik.errors.dateOfCompletion ? formik.errors.dateOfCompletion : null}</p>

                        </div>
                        <div className='col-span-1 mt-4'>
                            <label className="form-label inline-block mb-1 text-gray-600 text-sm font-semibold">
                                {/* <small className="block mt-1 text-sm font-semibold text-red-600 inline ">*</small> */}
                                Rain Water Harvesting Image </label>
                        ...
                        <div className='col-span-1 mt-4'>
                            <label className="form-label inline-block mb-1 text-gray-600 text-sm font-semibold">
                                {/* <small className="block mt-1 text-sm font-semibold text-red-600 inline ">*</small> */}
                            Rain Water Harvesting Form </label>
                            <input accept='.jpg,.jpeg,.pdf' type="file" name='rwhForm' className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none placeholder-gray-300 shadow-md"
                                placeholder=""
                                value={formik.values.rwhForm} onChange={handleChangeImage}
                            />
                            {/* <p className='text-red-500 text-xs'>{formik.touched.rwhImage && formik.errors.rwhImage ? formik.errors.rwhImage : null}</p> */}
