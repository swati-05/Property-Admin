...
import SafSamGeoTaggingTable from './SafSamGeoTaggingTable'

const SafSamGeoTagging = () => {

    const {get_MasterData, searchSafSamGeoTagging} = PropertyApiList()

    const [wardList, setwardList] = useState()
    const [dataList, setdataList] = useState()
    const [loader, setloader] = useState(false)

    useSetTitle('SAF, SAM and Geo-Tagging')
    ...
    const searchFun = () => {
        ...
        axios.post(
            searchSafSamGeoTagging, body, ApiHeader())
        .then((res) => {
...
export default SafSamGeoTagging