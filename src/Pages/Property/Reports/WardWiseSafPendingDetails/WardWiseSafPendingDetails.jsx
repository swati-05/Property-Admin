...
const WardWiseSafPendingDetails = () => {

    const { get_MasterData, searchWardWiseSafPendingDetails } = PropertyApiList()

    useSetTitle('Ward Wise SAF Pending Details')
    ...
    const searchFun = (values) => {
        ...
        axios.post(
            searchWardWiseSafPendingDetails, body, ApiHeader())
            .then((res) => {
    ...
    const COLUMNS = [
        {
            Header : 'SAF, SAM, Geotagging and Back To Citizen',
            columns: [
                {
                    Header: 'S.No.',
...
export default WardWiseSafPendingDetails