...
const PropSafIndDemCollection = () => {
    ...
    const { get_MasterData, searchPropSafIndDemCollection } = PropertyApiList()

    useSetTitle('Property/SAF Individual Demand And Collection')
    ...
    return (
        <>
            ...
            <form onChange={formik.handleChange} onSubmit={formik.handleSubmit} className="mb-4 bg-white shadow-lg rounded-md">
                <h1 className='text-xl w-full font-bold px-8 pt-4 text-gray-700'>Search Individual Demand And Collection</h1>
                ...
                <div className="flex flex-wrap flex-row justify-start w-full gap-x-6 gap-y-2 text-sm 3xl:text-base p-4 px-8">
                    ...
                    <div className="flex flex-col w-full md:w-[20%]">
                        ...
                        <div className="col-span-6">
                            <input type="text" name="key" id="" className={commonInputStyle} />
                        </div>
                    </div>
...

{
                ...
                api={searchPropSafIndDemCollection} // sending api
...
export default PropSafIndDemCollection