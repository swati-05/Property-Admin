...
const DeactivatedHolding = () => {

    const { get_MasterData, searchDeactivatedHolding } = PropertyApiList()

    useSetTitle('Deactivated Holding')
        ...
        <>
...

            {
                ...
                <ListTableConnect 
                    ...
                    api={searchDeactivatedHolding} // sending api
...
export default DeactivatedHolding