...
const PropSafCollectionReportwithRebatePenalty = () => {

    const {get_MasterData, searchPropCollectionReportwithRebatePenalty, searchSafCollectionReportwithRebatePenalty} = PropertyApiList()
    ...
    useSetTitle(type == 'property' ? 'Property Collection with Rebate and Penalty' : 'SAF Collection with Rebate and Penalty')
    ...
    const searchFun = () => {
        ...
        type == 'property' && (url = searchPropCollectionReportwithRebatePenalty)
        type == 'saf' && (url = searchSafCollectionReportwithRebatePenalty)
    ...
    const gettingMasterList = () => {
        ...
        .then((res) => {
            ...
            if(res?.data?.status == true){
                setpropertyList(res?.data?.property_type)
  ...
  return (
    <>
...

        {
            ...
            <ListTable2 count1={totalCount} columns={type == 'property' ? propColumn : safColumn} dataList={dataList} exportStatus={true} perPage={perPageCount} perPageC={perPageFun} totalCount={totalCount} nextPage={nextPageFun} prevPage={prevPageFun} exportDataF={exportDataFun} exportData={exportData} />
...
export default PropSafCollectionReportwithRebatePenalty