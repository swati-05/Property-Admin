...
const WardWiseCollectionSummary = () => {

  const { get_MasterData, searchWardWiseCollectionSummary, yearList } = PropertyApiList()

  useSetTitle('Ward Wise Collection Summary')
  ...
  const searchFun = (values) => {
    ...
    axios.post(
      searchWardWiseCollectionSummary, body, ApiHeader())
      .then((res) => {
        ...
        <div className="flex flex-wrap flex-row justify-start w-full gap-x-6 gap-y-2 text-sm 3xl:text-base p-4 px-8">
          ...
          <div className="flex flex-col w-full md:w-[20%]">
            ...
            <div className="col-span-6">
              <input value={formik.values.fromDate} type="date" name="fromDate" id="" className={commonInputStyle} disabled={loader} />
            </div>
          ...
          <div className="flex flex-col w-full md:w-[20%]">
            ...
            <div className="col-span-6">
              <input value={formik.values.uptoDate} type="date" name="uptoDate" id="" className={commonInputStyle} disabled={loader} />
            </div>
          </div>
...
export default WardWiseCollectionSummary