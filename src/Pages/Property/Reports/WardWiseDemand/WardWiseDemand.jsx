...
const WardWiseDemand = () => {

    const { get_MasterData, searchWardWiseDemand } = PropertyApiList()

    useSetTitle('Ward Wise Demand')
    ...
    const searchFun = (values) => {
        ...
        axios.post(
            searchWardWiseDemand, body, ApiHeader())
            .then((res) => {
