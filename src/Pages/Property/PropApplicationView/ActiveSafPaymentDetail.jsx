...
// import brief from '../../../src/Components/Media/brief.png'

import axios from 'axios'
import { Link } from 'react-router-dom'
import BackComponent from './BackComponent'

function ActiveSafPaymentDetail() {
                    ...
                    <table className='min-w-full leading-normal mt-10'>
                        <thead className='font-bold text-left text-sm bg-green-50 text-gray-600'>
                            <tr>
                                ...
                                <th className="px-2 py-3 border-b border-gray-200  text-left text-xs uppercase text-left">Saf No.</th>
                                <th className="px-2 py-3 border-b border-gray-200  text-left text-xs uppercase text-left">From finanacial year</th>
                                <th className="px-2 py-3 border-b border-gray-200  text-left text-xs uppercase text-left">Upto finanacial year</th>
                                <th className="px-2 py-3 border-b border-gray-200  text-left text-xs uppercase text-left">From Quater</th>
                                <th className="px-2 py-3 border-b border-gray-200  text-left text-xs uppercase text-left">Upto Quater</th>
                                <th className="px-2 py-3 border-b border-gray-200  text-left text-xs uppercase text-left">Transcation No.</th>
                                <th className="px-2 py-3 border-b border-gray-200  text-left text-xs uppercase text-left">Transcation Date</th>
                                <th className="px-2 py-3 border-b border-gray-200  text-left text-xs uppercase text-left">Amount</th>
                                <th className="px-2 py-3 border-b border-gray-200  text-left text-xs uppercase text-left">Penalty Amount</th>
                                <th className="px-2 py-3 border-b border-gray-200  text-left text-xs uppercase text-left">Discount Amount</th>
                                <th className="px-2 py-3 border-b border-gray-200  text-left text-xs uppercase text-left">Payable Amount</th>
                                <th className="px-2 py-3 border-b border-gray-200  text-left text-xs uppercase text-left">Demand Amount</th>
...
export default ActiveSafPaymentDetail