...
function ActiveSafDemandDetails(props) {
  const { id } = useParams();
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-2 lg:grid-cols-12 container mx-auto ">
        <div className="col-span-12 w-full bg-gray-50 rounded-lg p-4">
          <h1 className="px-2 font-semibold mt-0 text-center text-gray-600 font-serif py-2 xl md:text-3xl ">
            {" "}
            DEMAND DETAILS
          </h1>
          <div>
            {!loader && (
              <div className="md:px-10 text-right flex-1">
                <button
                  onClick={getOrderId}
                  type="submit"
                  className=" px-6 py-1 bg-green-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-green-700 hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-800 active:shadow-lg transition duration-150 ease-in-out"
                >
                  Pay Now{" "}
...
export default ActiveSafDemandDetails;
