...
function PropApplicationDetailById() {
  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-8 lg:grid-cols-8 gap-2 container mx-auto w-full p-4 mt-5  rounded-lg bg-white shadow-lg ">
        ...
        <div className="col-span-1  mx-auto">
          <button
            className="bg-amber-200 text-gray-600 border-b-2 shadow-lg border-white text-xs w-28 px-0 py-1 rounded-md text-center"
            onClick={() => navigate(`/propertyPayment`)}
          >
            {" "}
            PAYMENT DETAILS
          </button>
        ...
        <div className="col-span-1  mx-auto">
          <button
            className="bg-sky-200 text-gray-600 border-b-2 shadow-lg border-white text-xs  w-28 px-0 py-1 rounded-md text-center"
            onClick={() => navigate(`/safform/re/${safId}`)}
          >
            RE-ASSESSMENT
          </button>
        </div>
        <div className="col-span-1  mx-auto">
          <button
            className="bg-sky-200 text-gray-600 border-b-2 shadow-lg border-white text-xs  w-32 px-0 py-1 rounded-md text-center"
            onClick={() => navigate(`/waterHarvesting/${safId}`)}
          >
            WATER HARVESTING
          </button>
        </div>
        <div className="col-span-1  mx-auto">
          <button
            className="bg-sky-200 text-gray-600 border-b-2 shadow-lg border-white text-xs  w-28 px-0 py-1 rounded-md text-center"
            onClick={() => navigate(`/objection/${safId}`)}
          >
            OBJECTION
          </button>
        </div>
        <div className="col-span-1  mx-auto">
          <button
            className="bg-sky-200 text-gray-600 border-b-2 shadow-lg border-white text-xs  w-28 px-0 py-1 rounded-md text-center"
            onClick={() => navigate(`/con-form/${safId}`)}
          >
            CONCESSION
          </button>
        </div>
      ...
      <div className="col-span-1 p-2 float-right">
        <Link to="/search">
          <BackComponent />
        </Link>
      </div>
...
export default PropApplicationDetailById;
