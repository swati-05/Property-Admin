...
function CitizenTaxCard(props) {
    return (
        <>
            <div className="container h-full w-auto">
                <div className="flex items-center justify-center h-full float-right w-full">
                    <div className="bg-white shadow-2xl p-6 py-1 rounded-2xl border-2 border-green-400 relative h-full flex justify-center items-center">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="my-6">
                                <div className="flex flex-row space-x-4 items-center">
                                    ...
                                    <div id="temp">
                                        {/* <h4 className="text-4xl font-semibold text-center"><TbCurrencyRupee className="inline" /></h4> */}
                                        <h4 className="text-4xl font-semibold text-left"><TbCurrencyRupee className="inline" /> {props.tax}</h4>
                                        <p className="text-xs text-gray-500 text-center">{props.time}</p>
                                    </div>
                                </div>
                            </div>
