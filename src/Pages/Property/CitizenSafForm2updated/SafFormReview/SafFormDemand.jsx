        ...
        <div className='mt-4 px-20'>
          ...
          <div className="grid grid-cols-12 mt-8 ">
            <div className='text-md col-span-12 md:col-span-4'>
              ...
              <div>Rebate (Rs)<span className='text-black font-semibold font-mono ml-2'>{props?.safSubmitResponse?.data?.demand?.amounts?.rebateAmount}</span></div>
            ...
            <div className='col-span-12 md:col-span-4 pl-10 float-right'>
              <div>
                <span className='font-bold'> {props?.safSubmitResponse?.data?.safNo}</span> is your assessment application no, for any issue please go to your near jan seva kendra with this application no.
              </div>
            </div>
          </div>
                ...
                <tbody className="text-sm">
                  ...
                  <>
                    ...
                    <tr className="bg-white shadow-lg border-b border-gray-200">
                      ...
                      <td className="px-2 py-2 text-sm text-left">{props?.safSubmitResponse?.data?.demand?.amounts?.rebateAmount}</td>
                      <td className="px-2 py-2 text-sm text-left">{props?.safSubmitResponse?.data?.demand?.amounts?.specialRebateAmount}</td>
            ...
            <div className='mt-10'>
              ...
              <div className="w-full flex mb-10 mt-10">
                ...
                {/* <div className='text-right flex-1'>
                  <button onClick={() => navigate(`/safdocumentupload/${props?.safSubmitResponse?.data?.safId}/false`)} type="button" className="font-bold px-6 py-2 bg-indigo-500 text-white  text-sm leading-tight uppercase rounded  hover:bg-indigo-700 hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:bg-indigo-800 active:shadow-lg transition duration-150 ease-in-out shadow-xl border border-white">Upload Documents <span><BiRightArrowAlt className="inline font-bold text-xl" /></span> </button>
                </div> */}
