            ...
            <div className=''>
                ...
                <table className='min-w-full leading-normal mt-2'>
                    <thead className='font-bold text-left text-sm bg-indigo-600 text-white'>
                        <tr>
                            <th className="px-2 py-3 border-b border-gray-200  text-xs capitalize text-left">Building Type----Road Type</th>
                            <th className="px-2 py-3 border-b  text-xs capitalize text-left border-r border-l border-white">Building Pakka</th>
                            <th className="px-2 py-3 border-b border-gray-200  text-xs capitalize text-left">Building Kaccha</th>
