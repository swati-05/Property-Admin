...
function OccupancyFactor2() {
    return (
        <>
            <div className=''>
                <h1 className='px-2 font-semibold mt-4 text-gray-600 text-sm'><img className='inline w-6' src={Rate} alt="rate-image" /> Occupany factor 2</h1>
                ...
                <table className='min-w-full leading-normal mt-2'>
                    <thead className='font-bold text-left text-sm bg-indigo-600 text-white'>
                        <tr>
                            ...
                            <th className="px-2 py-3 border-b  text-xs capitalize text-left border-r border-l border-white">Occupancy Type</th>
...
export default OccupancyFactor2