...
function CitizenPropBasicDetail4(props) {
    ...
    const handleOnChange = (event) => {
        ...
        { name == 'propertyType' && props?.checkRuleSet(name,value) }
                ...
                <form onChange={handleOnChange} onSubmit={formik.handleSubmit}>
                    ...
                    <div className="grid grid-cols-12  sm:space-x-2">
                        ...
                        <div className="col-span-12  grid grid-cols-12 md:px-12  md:py-10 rounded-lg py-6">
                            ...
                            {props?.rulesetStatus?.apartment && <div className={`form-group col-span-12 md:col-span-3 mb-4 md:px-2`}>
                            ...
                            {props?.rulesetStatus?.landOccupationDate  && <div className={`form-group col-span-12 md:col-span-3 mb-4 md:px-2`}>
...
export default CitizenPropBasicDetail4