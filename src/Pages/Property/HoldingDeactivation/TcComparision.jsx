  ...
  return (
    <>
      ...
      <div className=" text-xl pb-4 md:py-4 text-gray-500">
        <span>Verified By : <span className="font-semibold text-gray-800">{comparisonData?.employee_details?.user_name}</span> </span>
        <span className="float-right">Verification Date : <span className="font-semibold text-gray-800">{comparisonData?.employee_details?.date}</span></span> </div>
        ...
        <div className='py-6 mt-2 rounded-lg shadow-lg p-4'>
          <div className="flex flex-col md:flex-row space-y-2 md:space-x-5 pl-4 ">
            <div className='flex-1'>
              <div className='font-bold text-sm'>{comparisonData?.saf_details?.saf_no ? comparisonData?.saf_details?.saf_no : "N/A"}</div>
              <div className='text-gray-500 text-xs'>SAF No.</div>
            </div>
            <div className='flex-1'>
              <div className='font-bold text-sm'>{comparisonData?.saf_details?.ward_no ? comparisonData?.saf_details?.ward_no : "N/A"}</div>
              <div className='text-gray-500 text-xs'>Ward No.</div>
            </div>
            <div className='flex-1'>
              <div className='font-semibold text-lg'>{comparisonData?.saf_details?.old_ward_no ? comparisonData?.saf_details?.old_ward_no : "N/A"}</div>
              <div className='text-gray-500 text-xs'>New Ward No</div>
            </div>
            <div className='flex-1'>
              <div className='font-semibold text-md'>{comparisonData?.saf_details?.ownership_type ? comparisonData?.saf_details?.ownership_type : "N/A"}</div>
              <div className='text-gray-500 text-xs'>Ownership Type</div>
            </div>
            <div className='flex-1'>
              <div className='font-bold text-sm'>{comparisonData?.saf_details?.property_type ? comparisonData?.saf_details?.property_type : "N/A"}</div>
          ...
          <div className="flex flex-col md:flex-row space-y-2 md:space-x-10  pl-4 mt-4">
            <div className='flex-1'>
              <div className='font-bold text-sm'>{comparisonData?.saf_details?.zone_mstr_id ? comparisonData?.saf_details?.zone_mstr_id : "N/A"}</div>
              <div className='text-gray-500 text-xs'>Zone</div>
            </div>
            <div className='flex-1'>
              <div className='font-bold text-sm'>{comparisonData?.saf_details?.road_type ? comparisonData?.saf_details?.road_type : "N/A"}</div>
              <div className='text-gray-500 text-xs'>Road Type</div>
            </div>
            <div className='flex-1'>
              <div className='font-semibold text-md'>{comparisonData?.saf_details?.holding_type ? comparisonData?.saf_details?.holding_type : "N/A"} </div>
              <div className='text-gray-500 text-xs'>Holding Type</div>
            </div>
            <div className='flex-1'>
              <div className='font-semibold text-md'>{comparisonData?.saf_details?.assessment_type ? comparisonData?.saf_details?.assessment_type : "N/A"}</div>
              <div className='text-gray-500 text-xs'>Assessment Type</div>
            </div>
            <div className='flex-1'>
              <div className='font-bold text-sm' >{comparisonData?.saf_details?.prop_address ? comparisonData?.saf_details?.prop_address : "N/A"}</div>
                ...
                comparisonData?.property_comparison?.map((data, index) => (
                  <tr class="border-b border-gray-200 ">
                    ...
                    <td class="px-6 py-3 darks:bg-gray-800 border-l border-l-gray-200">
                      ...
                      {data?.values == false && <TiDelete className="inline text-red-500 text-5xl" />}
                    </td>
                    <td class="px-6 py-3 border-l border-l-gray-200">
                      {data?.according_verification}
                    </td>
                  </tr>
                ))
              }
              ...
              {comparisonData?.floor_comparison?.map((data) => (
                <>
                  <tr className="border-b border-gray-200 ">
                    <td rowspan="3" className="px-6 py-3 border-l border-l-gray-200">{data?.floar_name}</td>
                    <td className="px-6 py-3 border-l border-l-gray-200 font-semibold text-gray-900">Self Assessed</td>
                    {
                      data?.values?.map((data) => (
                        <td className="px-6 py-3 border-l border-l-gray-200">{data?.according_application}</td>
                      ))
                    }
                  ...
                  <tr className="border-b border-gray-200 ">
                    ...
                    {
                      data?.values?.map((data) => (
                        <td className="px-6 py-3 border-l border-l-gray-200">{data?.verification?.according_verification}</td>
                      ))
                    }
                  </tr>
                </>
                      ...
                      <tr class="border-b border-gray-200 ">
                        ...
                        <th scope="row" class="px-6 py-3 font-medium text-gray-900 whitespace-nowrap  darks:bg-gray-800 border-l border-l-gray-200">
                          <span onClick={() => openModal(data?.imageUrl)} className="cursor-pointer">
                            ...
                            <img className="w-40" src={data?.paths} />
                          </span>
                        </th>
                        <td class="px-6 py-3 border-l border-l-gray-200">
                          {data?.latitude}
