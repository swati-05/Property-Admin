...
function NewStepper({ colorCode, currentStep }) {
    ...
    const [stepFiveDone, setStepFiveDone] = useState(0)
    ...
    const [lineFour, setLineFour] = useState("border-gray-300")
    ...
    const [currentPage5, setCurrentPage5] = useState("font-medium")
    ...
    const [currentPage5Border, setCurrentPage5Border] = useState("")
    ...
    useEffect(() => {
        ...
        if (currentStep == 1) {
            ...
            setCurrentPage5("font-bold bg-white border border-red-200 rounded")
            setCurrentPage5Border("border-dotted")
            ...
            <div class="mx-6 p-4 m-2">
                <div class="flex items-center ">
                    <div class="flex items-center text-gray-500 relative">
                        ...
                        <div className={` ${currentPage1} absolute top-0 -ml-10 text-center mt-14 w-32 text-xs capitalize text-teal-600`}>Basic </div>
                    </div>
                    ...
                    <div class="flex items-center text-gray-500 relative">
                        ...
                        <div className={` ${currentPage2} absolute top-0 -ml-10 text-center mt-14 w-32 text-xs capitalize text-teal-600`}>Firm </div>
                    </div>
                    <div class={`flex-auto border-t-2 transition duration-500 ease-in-out ${lineTwo} `}></div>
                    <div class="flex items-center text-gray-500 relative">
                        <div class={` ${stepThreeDone} ${currentPage3Border} rounded-full transition duration-500 ease-in-out h-10 w-10 py-3 border-2 border-teal-600 `}>
                        ...
                        <div className={` ${currentPage3} absolute top-0 -ml-10 text-center mt-14 w-32 text-xs capitalize text-teal-600`}>Owner </div>
                    </div>

                    <div class={`flex-auto border-t-2 transition duration-500 ease-in-out ${lineThree} `}></div>
                    <div class="flex items-center text-gray-500 relative">
                        <div class={` ${stepFourDone} ${currentPage4Border} rounded-full transition duration-500 ease-in-out h-10 w-10 py-3 border-2 border-teal-600 `}>
                        ...
                        <div className={` ${currentPage4} absolute top-0 -ml-10 text-center mt-14 w-32 text-xs capitalize text-teal-600`}>Payment </div>
                    </div>

                    {/* <div class={`flex-auto border-t-2 transition duration-500 ease-in-out ${lineFour} `}></div>
                    <div class="flex items-center text-gray-500 relative">
                        <div class={` ${stepFiveDone} ${currentPage5Border} rounded-full transition duration-500 ease-in-out h-10 w-10 py-3 border-2 border-teal-600 `}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-database ">
                                <ellipse cx="12" cy="5" rx="9" ry="3"></ellipse>
                                <path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"></path>
                                <path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"></path>
                        ...
                        <div className={` ${currentPage5} absolute top-0 -ml-10 text-center mt-14 w-32 text-xs capitalize text-teal-600`}>Document </div>
                    </div> */}
