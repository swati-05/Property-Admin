...
const ClusterView = (props) => {
  ...
  // ==========search function=================
  const searchFun = () => {
    searchKey.length > 4 && setisLoading2(true)
    ...
    searchKey.length > 4 ? axios.post(url, body, ApiHeader())
      ...
      .catch((err) => {
        ...
        activateBottomErrorCard(true, 'Error occured while searching. Please try again later')
        setisLoading2(false)
      }) :
    ...
    axios.post(url, body, ApiHeader())
      .then((res) => {
        ...
        if (res?.data?.status == false) {
          ...
          activateBottomErrorCard(true, `Check out some ${addCont} no. already mapped or selected !!!`)
        }
        setisLoading2(false)
      ...
      .catch((err) => {
        ...
        setisLoading2(false)
        activateBottomErrorCard(true, 'Error occured while mapping. Please try again later')
      })
  }
