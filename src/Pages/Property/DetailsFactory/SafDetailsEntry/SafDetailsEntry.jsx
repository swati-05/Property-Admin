                ...
                <>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-12 lg:grid-cols-12 gap-2 container sm:mx-auto w-full'>
                        ...
                        <div className="col-span-12 rounded-lg sm:p-4">
                            ...
                            <div className='hidden sm:block'> <TopTabs title={<div className='pl-4'>
                                <span className='py-1 justify-center items-center font-semibold '>
                                    {applicationFullData?.current_role_name !='' && <span>
                                    <FiInfo className="inline" /> This application is pending at <span className='bg-red-200 text-black px-4 py-1'>{applicationFullData?.current_role_name}</span>
                                    </span>}
                                    {applicationFullData?.current_role_name == '' && <span className='bg-green-200 text-black px-4 py-1 flex justify-center items-center' >
                                    <FiInfo className="inline mr-2" /> Holding Approved
                                    </span>}
                                </span>
                            </div>} type="application" id={id} safNo={''} active="property" /></div>
