                        ...
                        <table className='min-w-full leading-normal mt-2'>
                            <thead className='font-bold text-left text-sm bg-white text-gray-900'>
                                <tr>
                                    ...
                                    <th className="px-2 py-3 border-b border-gray-200  text-xs capitalize text-left">Occ. Factor</th>
                                    <th className="px-2 py-3 border-b border-gray-200  text-xs capitalize text-left">Carpert Area(70%/80%)</th>
                                    <th className="px-2 py-3 border-b border-gray-200  text-xs capitalize text-left">Renatal Rate/Matrix Factor</th>
                                    <th className="px-2 py-3 border-b border-gray-200  text-xs capitalize text-left">Tax Perc.</th>
                                    ...
                                    <th className="px-2 py-3 border-b border-gray-200  text-xs capitalize text-left">ARV/Total Property Tax</th>
                                    <th className="px-2 py-3 border-b border-gray-200  text-xs capitalize text-left">CV/Total Property Tax</th>
...
export default ComparativeDemand