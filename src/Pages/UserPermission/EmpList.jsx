...
function EmpList(props) {
    ...
    const [applicationLIst, setApplicationLIst] = useState([{ "id": 1, "name": "user" },
    { "id": 2, "role": "User" }])
                ...
                <div className='flex-initial flex'>
                    <div className="flex">
                        ...
                        <div className='text-xs ml-2'>
                            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" > <EmpAddModal roles={Roles} fun={fetchAppList}/> </button>
                        </div>
