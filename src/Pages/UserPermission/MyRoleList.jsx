...
import MyAddRoleModal from './MyAddRoleModal';


function MyRoleList(props) {
    ...
    const COLUMNS = [
        ...
        // },
        {
            Header: 'View Assigned User Types',
            accessor: 'id',
            Cell: ({ cell }) => (
                <button onClick={(e) => props.fun(cell.row.values.id)}
    ...
    const [applicationLIst, setApplicationLIst] = useState([{ "id": 1, "role": "Manager" },
    { "id": 2, "role": "User" }])
    ...
    const fetchAppList = () => {
        axios.get('http://localhost:3333/roles')
                ...
                <div className='flex-initial flex'>
                    <div className="flex">
                        ...
                        <div className='text-xs ml-2'>
                            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" > <MyAddRoleModal /> </button>
                        </div>
