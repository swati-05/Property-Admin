...
function MailboxLink(props) {
    ...
    return (
        <>
            ...
            <span className={(props.activeStatus ? "bg-indigo-500  rounded-md text-white font-semibold shadow-lg" : " text-gray-500 border border-gray-500 rounded-md") + " cursor-pointer flex items-center py-1 px-2 text-base"}>
