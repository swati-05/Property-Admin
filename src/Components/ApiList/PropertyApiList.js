...
export default function PropertyApiList() {
  ...
  let apiList = {
    ...
    searchHoldingWiseRebate: baseUrl + '/api/property/reports/property/holding-wise-fine-rebate',
    ...
    searchGovSafIndividualDemandCollection: baseUrl + '/api/property/reports/property/gbsaf-individual-demand-collection',
    ...
    searchRebatePenalty : baseUrlT + '/api/property/reports/rebate/penalty',
