          ...
          <div className='w-screen h-screen flex justify-center items-center'>
            <div className='w-2/3 h-60 bg-white mx-auto my-auto text-center flex justify-center items-center shadow-xl'>
              <div>
                ...
                <button onClick={() => window.location.replace('/property')} className="cypress_next1_button px-6 py-2.5 bg-indigo-500 text-white font-medium text-xs leading-tight  rounded  hover:bg-indigo-700 hover:shadow-lg focus:bg-indigo-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-indigo-800 active:shadow-lg transition duration-150 ease-in-out mt-5">Go Back</button>
              </div>
            </div>
          </div>
        </>
